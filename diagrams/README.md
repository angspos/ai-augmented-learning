...
![Full knowledge graph](diagrams/vault_cluster.png)
...
*A cold prompt — no prior context — and the AI re-teaches inheritance using the professor's own framing (`Dog → ServiceDog`, "is-a"), not a generic internet explanation. Code follows the style rules in CLAUDE.md (PEP 8, snake_case, docstrings) — guardrails that keep the AI aligned with how the course actually teaches.*
